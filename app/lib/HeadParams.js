...
var HeadParams = function (title, description) {
  this.title = title || "WebAngeles: Product Design & Software Engineering";
  this.description = description || "WebAngeles builds digital products that improve people's lives";
};
