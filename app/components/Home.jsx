...
var Home = React.createClass({
  componentWillMount: function() {
    this.props.headParams.setTitle("WebAngeles: We build software that improves people's lives");
    this.props.headParams.setDescription("WebAngeles is an interdisciplinary team of full-stack developers and engineers that help companies achieve their goals. We identify challenges, design solutions, and make technology human.");
  },
    ...
    return (
      <PageLayout {...this.props}>
        <section className="section-home-why">
          ...
          <img src="/img/webangeles.2lines.bird.png"/><br>&nbsp;</br>
            <h1 className="title-page">The future is real-time.</h1>
            <div className="note"><b>We build real-time, event-driven products.</b><br/><br/><br/><br/>
            <Router.Link to="how" className="btn-secondary caps">See how we do it</Router.Link></div>            
          </div>
        </section>
