      ...
      <div className="overlay-screen-menu" onClick={this.handleClick}>
        ...
        <div className="wrapper-menu">
          ...
          <div className="level-bottom">
            ...
            <br />
            <a href="http://twitter.com/webangeles" className="monochrome" target="_blank"><span className="icon-twitter"></span></a>
            <a href="http://github.com/webangeles" className="monochrome" target="_blank"><span className="icon-github"></span></a>
          </div>
        </div>
      </div>
    );
