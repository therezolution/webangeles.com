...
var How = React.createClass({
  componentWillMount: function () {
    this.props.headParams.setTitle("How | WebAngeles");
    ...
    return (
      <PageLayout {...this.props}>
        ...
        <section className="section-team">
          ...
          <a className="grid-4 avatar" href="#" rel="nofollow" target="_blank">
            <img title="Reza Kaabi" src="/img/portraits-reza.jpg" />
            <div className="name">Reza Kaabi</div>
          </a>
          <a className="grid-4 avatar" href="#" rel="nofollow" target="_blank">
            <img title="Timothy Hingston" src="/img/portraits-hai-280x360.jpg" />
