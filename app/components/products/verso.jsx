...
var product = {
  ...
  index: 2,
  title: "Verso",
  description: "WebAngeles designed, engineered, and strategized Verso Learning's entry into the education app market",
        ...
        <div className="collage">
          ...
          <div className="grid-2 quote-collage">
            <div className="wrapper-quote">
              <div className="title-quote">&ldquo;WebAngeles provides a rare blend of technical rigour, aesthetic elegance and lucid comms. These guys add value to every stage of the product lifecycle.&rdquo;</div>
