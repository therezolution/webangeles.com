...
var job = {
  ...
  type: "intern",
  title: "Design Intern",
  description: "Join our design team to research, design, and prototype new user experiences at WebAngeles San Francisco.",
  locations: "SFO"
};
    ...
    return (
      <PageLayout {...this.props}>
        ...
        <section className="section-about">
          ...
          <ol className="details-about">
            <li className="grid-2-collapse"><span className="meta">Why do you want to intern at WebAngeles?</span></li>
        ...
        <section className="section-button">
          <a className="btn-primary caps" href="mailto:reza@webangeles.com?subject=Hello%20WebAngeles">Apply for Internship</a>
        </section>
      </PageLayout>
    );
  }
