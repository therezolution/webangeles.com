...
var What = React.createClass({
  ...
  componentWillMount: function () {
    this.props.headParams.setTitle("What | WebAngeles");
    this.props.headParams.setDescription("WebAngeles designs and engineers digital products. We create beautiful, simple, and performant software that helps companies achieve their goals.");
  },
      ...
      <PageLayout {...this.props}>
        ...
        <header className="collage medium">
          <div className="grid-2-square">
            ...
            <p className="description-page">WebAngeles designs and engineers digital products. We create beautiful, simple, and performant software that helps companies achieve their goals.</p>
          </div>
